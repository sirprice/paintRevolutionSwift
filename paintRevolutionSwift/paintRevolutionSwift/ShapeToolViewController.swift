...
class ShapeToolViewController: NSViewController {
...
extension ShapeToolViewController : NSTableViewDataSource {
    func numberOfRows(in tableView: NSTableView) -> Int {
        return tools.shapeTools.count
    }
}

extension ShapeToolViewController : NSTableViewDelegate {
